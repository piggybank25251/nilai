...
?>
            <div class="card-body">
                <form action="?m=kelas&s=update" method="post">
                    ...
                    <div class="mb-3">
                    <input type="number" name="kapasitas" value="<?=$r['kapasitas']; ?>" class="form-control" placeholder="kapasitas" required autofocus>
                    </div>
                    <div class="mb-2">
                    <input type="number" name="terisi" value="<?=$r['terisi']; ?>" class="form-control" placeholder="terisi" required autofocus>
                    </div>
                    <div class="mb-3">
